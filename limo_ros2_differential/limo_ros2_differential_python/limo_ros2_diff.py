...
class LimoROS2Diff(BaseSample):
    def __init__(self) -> None:
        ...
        self._path_to_robot_usd = os.path.join(self._base_dir, "../data/WegoLimo/Limo/limo_diff_thin.usd")
        self._path_to_track_usd = os.path.join(self._base_dir, "../data/WegoLimo/LimoTrack/LIMO_simulation_table.usd")
        ...
        self._imuPrim= "/World/Limo/Imu_Sensor"
